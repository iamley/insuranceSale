 ...
 *
 * Because of symlinking you can still type `ng build/testing/lint` in the terminal. The ng command, in this case,
...
/**
 * Symlink of ng to nx, so you can keep using `ng build/testing/lint` and still
